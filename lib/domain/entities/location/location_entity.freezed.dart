...
class _$LocationEntityImpl implements _LocationEntity {
  ...
  @override
  String toString() {
    return 'LocationEntity(name: $name, region: $region, country: $country, lat: $lat, lon: $lon, tzId: $tzId, localtimeEpoch: $localtimeEpoch, localtime: $localtime)';
  }
...
abstract class _LocationEntity implements LocationEntity {
  const factory _LocationEntity(
      ...
      final String? tzId,
      final int? localtimeEpoch,
      final String? localtime}) = _$LocationEntityImpl;
